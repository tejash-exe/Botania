                ...
                {isAuth ? <>
                    <div className={'lg:mx-20 sm:mx-10 mx-2 duration-300' + ((cropPopup) ? ' blur-sm ' : ' ')}>
                        ...
                        <div className='flex items-center sm:justify-end justify-center'>
                            ...
                            <button className='my-3 px-3 py-2 rounded-md border border-red-400 hover:border-red-600 bg-red-400 text-white hover:bg-red-600 duration-200 active:scale-95' onClick={handleLogout}>Log out</button>
                        </div>
                    </div>
